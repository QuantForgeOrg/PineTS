...
describe('UNKNOWN Namespace - SIMPLE-ARITHMETICS Method', () => {
    it('should calculate SIMPLE-ARITHMETICS correctly with native series and variable series', async () => {
        ...
        const expectFilePath = path.join(__dirname, 'simple-arithmetics.expect.json');
